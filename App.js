...
let itemsRef = db.ref('/PowerMeter1');
  ...
  render() {
    return (
      ...
      <ListItem>
        ...
        <Body>
          <Text> {this.state.items[0]} Ampere</Text>
        </Body>
      </ListItem>
      <ListItem>
        <Badge>
      ...
      <ListItem>
        ...
        <Body>
          <Text> {this.state.items[11]} Volt</Text>
        </Body>
      </ListItem> 
      <Separator bordered>
          <Text style={styles.separator}>พลังงานไฟฟ้า 3 เฟส</Text>
      </Separator>
      <ListItem>
        <Badge success>
          <Text>P1</Text>
        ...
        <Body>
          <Text> {this.state.items[4]} KW</Text>
        </Body>
      </ListItem>
      <ListItem>
        <Badge success>
        ...
        <Body>
          <Text> {this.state.items[5]} KW</Text>
        </Body>
      </ListItem>     
      <ListItem>
        <Badge success>
        ...
        <Body>
          <Text> {this.state.items[6]} KW</Text>
        </Body>
      </ListItem>   
      <ListItem>
        <Badge success>
        ...
        <Body>
          <Text> {this.state.items[7]} KW</Text>
        </Body>
      </ListItem>        
      </Content>
    </Container>
